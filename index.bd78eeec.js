...
(0, _preact.render)((0, _preact.h)(_App["default"], null), document.querySelector('#app'));

},{"preact":"4L2dE","./App":"6Pm2X"}],"4L2dE":[function(require,module,exports) {
...
var _particlesjsConfig = _interopRequireDefault(require("url:../static/particlesjs-config.json"));
function _interopRequireDefault(obj) {
  return obj && obj.__esModule ? obj : {
    "default": obj
  };
...
var App = /*#__PURE__*/(function (_Component) {
  ...
  _createClass(App, [{
    ...
    value: function componentDidMount() {
      ...
      particlesJS.load('particles-js', _particlesjsConfig["default"]);
    }
  }, {
    key: "render",
    value: function render() {
      return (0, _preact.h)("div", {
        className: "container"
      }, (0, _preact.h)(_Card["default"], null), (0, _preact.h)("div", {
        id: "particles-js"
      }));
    }
  }]);
...
},{"preact":"4L2dE","./Card":"2IQyC","particles.js/particles":"2zT3A","url:../static/particlesjs-config.json":"1OLmS"}],"2IQyC":[function(require,module,exports) {
"use strict";
function _typeof(obj) {
  "@babel/helpers - typeof";
  if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") {
...
var Card = /*#__PURE__*/(function (_Component) {
    ...
    _this.state = {
      ...
      skills: [{
        ...
        items: [{
          ...
          name: 'Bootstrap, Angular Material, DevExtreme'
        }, {
          name: 'React'
        }, {
          name: 'Vue 2, Vuex, Vue-router'
        }, {
          name: 'Angular 2+, RxJs, NgRx'
        }]
      }, {
        title: 'Used Techs',
        items: [{
      ...
      links: [{
        name: 'Github',
        href: 'https://github.com/yuugou727/'
      }, {
        name: 'Blog',
        href: 'https://yuugou727.github.io/blog/'
      }, {
        name: 'LinkedIn',
        href: 'https://www.linkedin.com/in/ronniechangtw/'
      }]
    };
    return _this;
  }
  _createClass(Card, [{
    ...
    value: function render() {
      ...
      return (0, _preact.h)("div", {
        className: "card hide",
        ref: function ref(myCard) {
          return _this3.myCard = myCard;
        }
      }, (0, _preact.h)("div", {
        className: "cardTop"
      }, (0, _preact.h)("div", {
        ...
        className: "basicInfo"
      }, (0, _preact.h)("h2", null, this.state.name), (0, _preact.h)("h5", null, this.state.location), (0, _preact.h)("h4", null, this.state.title), (0, _preact.h)("h6", null, "Preferred env.: ", this.state.env))), (0, _preact.h)("div", {
        className: "skills"
      }, this.state.skills.map(function (type) {
        return (0, _preact.h)("div", {
          className: "skill",
          key: type.title
        }, (0, _preact.h)("p", {
          className: "skill-title"
        }, type.title), (0, _preact.h)("ul", null, type.items.map(function (v) {
          return (0, _preact.h)("li", {
            key: v.name
          }, v.name);
        })));
      })), (0, _preact.h)("div", {
        className: "cardButtom"
      }, (0, _preact.h)("div", {
        className: "buttons"
      }, this.state.links.map(function (v) {
...
},{"preact":"4L2dE"}],"2zT3A":[function(require,module,exports) {
/* -----------------------------------------------
...
},{}],"1OLmS":[function(require,module,exports) {
module.exports = require('./bundle-url').getBundleURL() + "particlesjs-config.7a933ddb.json"
...
},{}]},["1Ypau","30Yv7"], "30Yv7", "parcelRequire0002")
